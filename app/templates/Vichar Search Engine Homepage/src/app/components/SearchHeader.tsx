...
export function SearchHeader({ initialQuery = '', isDarkMode = false, onToggleTheme }: SearchHeaderProps) {
  ...
  return (
    <header className="sticky top-0 bg-background border-b border-border/40 z-40">
            ...
            >
              <div className="flex items-center h-full px-5 gap-3">
                ...
                <input
                  ...
                  className="flex-1 bg-transparent border-none outline-none text-foreground placeholder:text-muted-foreground/60 text-[14px]"
                />
              </div>
            </div>
          </form>
